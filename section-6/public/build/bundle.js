...
var app = (function () {
    ...
    /* src/Product.svelte generated by Svelte v3.40.2 */
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 19, 4, 349);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 16, 4, 285);
    			add_location(h2, file$2, 17, 4, 306);
    			add_location(button0, file$2, 21, 4, 381);
    			add_location(button1, file$2, 22, 4, 435);
    			add_location(article, file$2, 15, 0, 271);
    		},
    ...
    /* src/Modal.svelte generated by Svelte v3.40.2 */
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 79, 12, 1599);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "backdrop svelte-ycthnq");
    			add_location(div0, file$1, 65, 0, 1153);
    			attr_dev(header, "class", "svelte-ycthnq");
    			add_location(header, file$1, 67, 4, 1242);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file$1, 70, 4, 1305);
    			add_location(p, file$1, 74, 8, 1397);
    			add_location(button, file$1, 75, 8, 1462);
    			attr_dev(div2, "class", "disclaimer");
    			add_location(div2, file$1, 73, 4, 1364);
    			add_location(footer, file$1, 77, 4, 1531);
    			attr_dev(div3, "class", "modal svelte-ycthnq");
    			add_location(div3, file$1, 66, 0, 1218);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (header_slot) {
    				if (header_slot.p && (!current || dirty & /*$$scope*/ 4)) {
    					update_slot(header_slot, header_slot_template, ctx, /*$$scope*/ ctx[2], !current ? -1 : dirty, get_header_slot_changes, get_header_slot_context);
    				}
    			}
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(50:0) {#each products as product}",
    		ctx
    	});
    ...
    // (61:0) <Modal     on:cancel={() => (showModal=false)}     on:close={() => (showModal=false)}     let:didAgree={closeable}     >
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(61:0) <Modal     on:cancel={() => (showModal=false)}     on:close={() => (showModal=false)}     let:didAgree={closeable}     >",
    		ctx
    	});
    ...
    function create_header_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 65, 4, 1518);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 67, 4, 1575);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 57, 0, 1314);
    			attr_dev(textarea, "rows", "5");
    			textarea.value = /*text*/ ctx[1];
    			add_location(textarea, file, 71, 0, 1685);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
