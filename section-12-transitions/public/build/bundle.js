...
var app = (function () {
    ...
    /* src/Spring.svelte generated by Svelte v3.40.2 */
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$1, 81, 6, 1387);
    			this.first = div;
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 79, 2, 1321);
    			attr_dev(div1, "class", "page svelte-1a1ekzd");
    			add_location(div1, file$1, 78, 0, 1300);
    		},
    ...
    // (58:4) {#each boxes as box (box)}
    function create_each_block(key_1, ctx) {
    	let div;
    	let t_value = /*box*/ ctx[12] + "";
    	let t;
    	let div_transition;
    	let rect;
    	...
    	const block = {
    		...
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "svelte-spwgp2");
    			add_location(div, file, 58, 8, 1252);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*boxes*/ 4) && t_value !== (t_value = /*box*/ ctx[12] + "")) set_data_dev(t, t_value);
    		},
    		r: function measure() {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(58:4) {#each boxes as box (box)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 47, 0, 952);
    			add_location(hr, file, 52, 0, 1107);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "class", "svelte-spwgp2");
    			add_location(input, file, 53, 0, 1112);
    			add_location(button1, file, 54, 0, 1153);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function discard(val) {
    		$$invalidate(2, boxes = boxes.filter(el => el !== val));
    	}
    	...
    	const outroend_handler = () => console.log('Revoming the element ends');
