...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file, 51, 4, 1340);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file, 53, 12, 1390);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(53:8) {#each hobbies as hobby}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file, 44, 0, 1166);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 45, 0, 1199);
    			add_location(button, file, 46, 0, 1242);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	fetch('https://svelte-course-917a0-default-rtdb.europe-west1.firebasedatabase.app/hobbies.json').then(res => {
    		if (!res.ok) {
